...
function onDone(imports, flags, ngrokUrl, stats) {
  ...
  if (!hasErrors && !hasWarnings) {
    return (0, _webpackMessages.devServerCompiledSuccessfullyMsg)(imports, flags, ngrokUrl);
  }
  ...
  if (hasErrors) {
    (0, _webpackMessages.devServerFailedToCompileMsg)(imports, flags, ngrokUrl);
  ...
  if (hasWarnings) {
    (0, _webpackMessages.devServerCompiledWithWarningsMsg)(imports, flags, ngrokUrl);
...
function createWebpackCompiler(config, flags, ngrokUrl) {
  ...
  compiler.apply((0, _webpackDashboard2.default)(flags, ngrokUrl));
  return compiler;
}
